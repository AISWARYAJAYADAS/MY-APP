    ...
    when (logoutState) {
        ...
        is LogoutViewState.LogoutSuccess  -> {
            if (!showToast) {
                ...
                viewModel.clearSharePrefValues() // Clear user-related data
                Log.d("Clear Data", "${viewModel.clearSharePrefValues()}")

                // Navigate to the authentication screen after successful logout
//                navController.popBackStack(
